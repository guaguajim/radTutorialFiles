...
#This simulation is for a point-in-time sky vector. Annual results can be generated by using a sky matrix generated through gendaymtx. That example is covered in 3Ph.sh
#While not described in this file, a more elegant way to approach such simulations will be through a for-loop.
